...
<form method="POST">
    <div class="form-group">
        ...
        <input type="text" class="form-control" maxlength="100" id="titulo" name="titulo" placeholder="Crie um título para o comentário" />
    </div>
    <div class="form-group">
        <label for="texto">Texto do Comentário</label>
        <textarea rows="4" class="form-control" maxlength="255" id="texto" name="texto" placeholder="Digite aqui o seu comentário"></textarea>
    </div>
